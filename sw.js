...
const VERSION = 'dfst-v52';
const ASSETS = ['index.html', 'app.js', 'calc.js', 'config.js', 'vendor/supabase.js', 'vendor/qr.js', 'manifest.webmanifest', 'favicon-32.png', 'icon-192.png', 'icon-512.png', 'icon-maskable-512.png', 'apple-touch-icon.png'];
