...
const VERSION = 'dfst-v51';
const ASSETS = ['index.html', 'app.js', 'calc.js', 'config.js', 'vendor/supabase.js', 'manifest.webmanifest', 'favicon-32.png', 'icon-192.png', 'icon-512.png', 'icon-maskable-512.png', 'apple-touch-icon.png'];
